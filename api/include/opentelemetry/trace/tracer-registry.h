#ifndef INCLUDE_OPEN_TELEMETRY_TRACE_TRACER_FACTORY_H_
#define INCLUDE_OPEN_TELEMETRY_TRACE_TRACER_FACTORY_H_
#include <map>
#include <memory>
#include <string>
...
#endif  // INCLUDE_OPEN_TELEMETRY_TRACE_TRACER_FACTORY_H_
